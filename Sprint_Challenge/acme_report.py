...
def inventory_report(products):
    ...
    average_price = (sum([product.price for product in products])
                     / len(products))
    average_weight = (sum([product.weight for product in products])
                      / len(products))
    average_flammability = (sum([product.flammability for product in products])
                            / len(products))
